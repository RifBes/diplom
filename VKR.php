...
?>
	...
	<div class="intro">
		<h1><center>ВКР</center></h1>
		<p>На этой странице представлены актуальные темы выпускных квалификационных работ студентов.</p>
