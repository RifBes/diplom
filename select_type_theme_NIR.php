...
if (isset($_POST['request'])) {
	...
	$query = "CREATE TEMPORARY TABLE tmp as SELECT topics_NIR.type as thema_type, topics_NIR.year as thema_year, topics_NIR.name_theme AS thema, Students.name as stud_name, Students.surname as stud_surname, Students.middle_name as stud_middlename, topics_NIR.student as stud_id, topics_NIR.teacher as teacher_id FROM topics_NIR LEFT OUTER JOIN Students ON topics_NIR.student = Students.id_s;";
